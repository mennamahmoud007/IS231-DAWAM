// OLD: was using localStorage before integrating Django backend
// Now data is rendered from server using Django templates so i will comment out the JS code that was used for localStorage rendering.
